...
%% LOADING
clear all
%data_dir = '/Volumes/MelSSD/runs/base_shared_reg/' ;
data_dir = '/scratch_net/biwidl307/sonia/USImageReconstruction-Melanie/runs/32_mix_ideal_20l_reg/'
%save_dir = '/Volumes/MelSSD/runs/base_shared_reg/eval-vn-120000/model_params' ;
save_dir = '/scratch_net/biwidl307/sonia/USImageReconstruction-Melanie/runs/32_mix_ideal_20l_reg/eval-vn-120000/model_params'
m = load(fullfile(data_dir, 'dm-train-60000.mat')) ;
nlayer = 20;
shared=true;
%% Create the dirs
...
for layer = 1:nlayer
    ...
    h = suptitle(sprintf('Layer %d', layer));
...
for layer = 1:nlayer
    h = suptitle(sprintf('Filters of layer %d', layer));
...
for layer = 1:nlayer
    ...
    h = suptitle(sprintf('Spatial weights of layer %d', layer));
    set(h, 'FontName', 'Palatino', 'FontSize', 14) ;
    for i = 1:32
          subplot(5,7,i)

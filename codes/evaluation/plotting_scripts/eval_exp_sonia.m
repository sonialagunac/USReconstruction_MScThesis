%% Load data
%Directories and models adapted to Sonia Laguna, MSc Thesis 2022
clear all
...
save_dir = '/scratch_net/biwidl307/sonia/USImageReconstruction-Melanie/runs/32_mix_ideal_20l_reg_mix_datareg/';
...
data_dir_10 = '/scratch_net/biwidl307/sonia/USImageReconstruction-Melanie/runs/32_mix_ideal_20l_reg_mix_datareg/eval-vn-120000/';
data_dir_20 = '/scratch_net/biwidl307/sonia/USImageReconstruction-Melanie/runs/32_mix_ideal_20l_reg_mix_datareg/eval-vn-120000/';
data_dir_30 = '/scratch_net/biwidl307/sonia/USImageReconstruction-Melanie/runs/32_mix_ideal_20l_reg_mix_datareg/eval-vn-120000/';
...
ylabel('RMSE'); title({'RMSE on FULLPIPELINE validation set', median(RMSEvn_10)}); 
...
x = categorical({'VN 10 layers', 'VN 20 layers', 'VN 30 layers', 'LBFGS'}) ;
boxplot([RMSEvn_10(:), RMSEvn_20(:), RMSEvn_30(:), RMSElbfgs(:)], x, 'Colors', 'k', 'Symbol', 'k+', 'DataLim', [0, 300], 'Jitter', 0.1)
ylabel('RMSE'); title({'RMSE on FULLPIPELINE test set', median(RMSEvn_10)});
set(gca, 'FontName', 'Palatino', 'FontSize', 13);

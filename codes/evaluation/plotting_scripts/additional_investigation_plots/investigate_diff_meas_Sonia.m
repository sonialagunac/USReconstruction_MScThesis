...
data_dir = '/scratch_net/biwidl307/sonia/USImageReconstruction-Melanie/runs/32_mix_ideal_20l_reg_mix/eval-vn-120000/'
m_test_syn = load(fullfile(data_dir, 'test-syn-0.0-0.6-patchy-testset_ideal_MS_32_imgs.mat'));
m_test_full = load(fullfile(data_dir, 'test-syn-0.0-0.0-test-fullpipeline_testset_6comb_32_imgs.mat'));

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Generates inverse crime data test set for MS on VS
...
close all hidden
clear all
cd '/scratch_net/biwidl307/sonia/USImageReconstruction-Sonia/codes/data_generation/jason_reconstruction/revised_jason_codes';
data_dir = '/scratch_net/biwidl307/sonia/data_original/VS';
addpath '/scratch_net/biwidl307/sonia/USImageReconstruction-Sonia/codes/data_generation/data_generation_Melanie'
addpath(cd);
...
METHOD = 'VS';
Nimgs = 32;
fname = 'testMS_VS_15comb_IC_32.mat';
include_smooth = true;
fix = true;
max_number_incl = 1;
%% geometry parameters
...
%% Load L Matrix
load('/scratch_net/biwidl307/sonia/USImageReconstruction-Sonia/codes/evaluation/jason_reconstruction/SoSReconstruction/data_generation_Sonia/revised_jason_codes/L_VS_revised.mat')
L = L_raw;
L_lr = L;
L_hr = L;
%%
...
%% Loading FP data
FP_dir = '/scratch_net/biwidl307/sonia/data_original/test/testset_ideal_MS_32_imgs.mat'
...
%% Save data
save(fullfile(data_dir, fname), 'imgs_gt', 'measmnts', 'L', 'L_fact', 'maskFixed', '-v7');
